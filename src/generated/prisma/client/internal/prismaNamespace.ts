...
> = {
	...
	meta: {
		modelProps: 'word' | 'category' | 'example';
...
export const ExampleScalarFieldEnum = {
	id: 'id',
	wordId: 'wordId',
	affirmativeEn: 'affirmativeEn',
	affirmativePt: 'affirmativePt',
	negativeEn: 'negativeEn',
	negativePt: 'negativePt',
	interrogativeEn: 'interrogativeEn',
	interrogativePt: 'interrogativePt',
} as const;
